package in.sheetalsingh.EncryptionSystem;
...
int wdth,hight;
    ...
    public Cryptography() {
		...
		image=new ImageIcon("C:\\Users\\sheetal\\Downloads\\Encryption-Project\\Encryption Project\\src\\in\\sheetalsingh\\EncryptionSystem\\AlarmedGenerousDrake-max-1mb.gif");
...
{
	long k=0;
	String keyInput=JOptionPane.showInputDialog(null,"Enter the Key","SECURE KEYS",JOptionPane.QUESTION_MESSAGE);
	long intKey=(long)Integer.parseInt(keyInput);
	long temp=intKey;
	checking:
	{
	do
